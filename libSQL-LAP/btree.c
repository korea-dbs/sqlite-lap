...
//declare func define var
#include <liburing.h>
#include "pager.h"
#include <time.h>
#include <pthread.h>
#define MAX_PGNO 80000
...
typedef struct {
	int count;
	int childpgno[MAX_PREFETCH];
}FIPPages;
FIPPages bitmap_map[MAX_PGNO];
bool FIPcurtoggle = 0;
bool sqltoggle = 0;
int test_cnt = 0;
static struct io_uring ring;
static int ring_initialized = 0;
static struct iovec iovecs[MAX_PREFETCH];
static char iov_buffers[MAX_PREFETCH][4096];
...
//end
//single THD iouring-movetochild
